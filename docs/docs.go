...
const docTemplate = `{
        ...
        "/batches/{short_id}/recordings/complete": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Key returned by the presign call, plus metadata",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.completeRecordingRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/batches/{short_id}/recordings/presign": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Filename and content type of the video to upload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.presignRecordingRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "upload_url, key, public_url",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        ...
        "controller.completeRecordingRequest": {
            "type": "object",
            "required": [
                "key"
            ],
        ...
        "controller.presignRecordingRequest": {
            "type": "object",
            "required": [
                "content_type",
                "filename"
